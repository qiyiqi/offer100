		...
		<div class="main-view col-xs-12">
			<div id="login-box" class="row">
				<div class="box col-sm-6 col-sm-offset-3">
					...
					<form name="form" class="form-horizontal" action="/offer100/company/login" method="post">
						<div class="form-group">
							<label class="col-sm-3 control-label">企业邮箱</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" name="cEmail" required="required"/>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" lay-verify="password" name="cPassword" required="required"/>
							</div>
					...
					<div class="row">
						<div class="col-md-12 center">
							<h4 class="title">还没有注册企业账户?</h4>
							<div class="col-sm-6 col-sm-offset-3">
								<a type="button" class="btn" href="com_register.jsp">注册</a>
							</div>
						</div>
					</div>
					<br />
