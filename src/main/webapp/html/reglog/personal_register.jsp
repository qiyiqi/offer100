		...
		<div class="main-view col-xs-12">
			<div id="login-box" class="row">
				<div class="box col-sm-6 col-sm-offset-3">
					...
					<form name="form" action="/offer100/user/register" class="form-horizontal" method="post">
						<div class="form-group">
							<label class="col-sm-3 control-label">用户名</label>
							<div class="col-sm-6">
								<input id="username" type="text" class="form-control required" name="uName" required="required"/>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control required" name="uPassword" required="required"/>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control required" name="uEmail" required="required"/>
							</div>
							<div class="col-sm-3"></div>
						</div>
						<div class="form-group">
