		...
		<div class="main-view col-xs-12">
			<div id="login-box" class="row">
				<div class="box col-sm-6 col-sm-offset-3">
					...
					<form name="form" action="/offer100/admin/editUserInfo" class="form-horizontal" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control required" name="uPassword" required="required" value="${user.uPassword }"/>
							</div>
							<div class="col-sm-3"></div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control required" name="uEmail" required="required" value="${user.uEmail }"/>
							</div>
							<div class="col-sm-3"></div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" name="uPhoto" value="${user.uPhoto }"/>
							</div>
							<div class="col-sm-3"></div>
						</div>
